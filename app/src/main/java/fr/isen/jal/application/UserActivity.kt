...
import fr.isen.jal.application.R
import fr.isen.jal.application.databinding.ActivityUserBinding
import fr.isen.jal.application.network.NetworkConstants
import fr.isen.jal.application.network.User
import fr.isen.jal.application.network.UserResult
...
class UserActivity : AppCompatActivity(), UserActivityFragmentInteraction {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportFragmentManager.beginTransaction().add(R.id.fragmentContainer, registerFragment)
            .commit()
    }
    ...
    private fun launchRequest(
        ...
        val request = JsonObjectRequest(
            ...
            parameters,
            {
                ...
                val userResult =
                    GsonBuilder().create().fromJson(it.toString(), UserResult::class.java)
